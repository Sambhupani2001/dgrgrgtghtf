      ...
      <div class="text-center to the parent div to align text or any item inside to the center">
        ...
        <div class="container">
            <div class="row">
              ...
              <div class="col">
              <h4 style="font-style: italic;">Penguins are flightless seabirds that live almost exclusively below the equator. Some island-dwellers can be found in warmer climates, but most—including emperor, adélie, chinstrap, and gentoo penguins—reside in and around icy Antarctica. They live almost exclusively in the southern hemisphere: only one species, the Galápagos penguin, is found north of the Equator. Highly adapted for life in the wate.</h4>
              </div>
              <div class="text-center to the parent div to align text or any item inside to the center">
